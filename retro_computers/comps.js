...
body:"Компьютер Pengaton 128 это стандарт ZX Spectrum совместимых компьютеров в СССР\x0Aи СНГ. Все игры и демо-программы в СССР или СНГ писались и пишутся либо для\x0Aкомпьютера \x22ZX Spectrum 48К\x22, либо для компьютера \x22Pengaton 128\x22.\x0A\x0AТак мне сказали люди, которые и в 2020-х годах продолжают писать программы для\x0Aэтого компьютера. Но где то пишут программы и для более современных ZX Specturm\x0Aсовместимых компьютеров, например русского ZX Evolution или иностранного ZX\x0ASpectrum Next. Поэтому решать вам.\x0A\x0AКомпьютер Pentagon 128 умеет все, что умеет оригинальный компьютер ZX Spectrum\x0A128. Только в него еще встроен контроллер дисковода Beta Disk Interface и он\x0Aнемного быстрее оригинального компьютера.\x0A\x0AНа первых версиях плат компьютеров Pengaton 128 не было места под звуковой\x0Aсинтезатор AY-3-8910. Он устанавливался на отдельную плату. В моей новодельной\x0Aплате 2017 года этот звуковой синтезатор уже впаян основную в плату.\x0A\x0AКакого то определенного корпуса у компьютера Pengaton 128 не было. Была какая\x0Aто коробка закрывающая ужас внутри. Но в этой коробке никто узнать Пентагон не\x0Aмог. Компьютер Pengaton 128 узнают не по корпусу и не по клавиатуре, а по\x0Aпечатной плате.\x0A\x0AПо моему личному мнению, компьютер \x22Pengaton 128\x22 можно рассматривать как\x0Aпродолжение радиолюбительских компьютеров для самостоятельной сборки: Микро-80,\x0AРадио 86РК, Специалист, Орион 128, Ленинград, Пентагон 128.\x0A\x0AЯ считаю эту плату самой красивой потому что в качестве блокировочных\x0Aконденсаторов использованы SMD. И установлены они с обратной стороны платы.\x0AСверху плата выглядит максимально аутентично. Конденсаторы не мешают любоваться\x0Aплатой. Их не видно и они никуда не могут замкнуть.\x0A\x0A",
},
"english.txt":{
},
"photo":{
...
"my_emulator":{
dir:1,name:"Эмулятор Специалист", items:{
"file_loderun.js":{
},
